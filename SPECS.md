...
- Double-clicking empty canvas creates an editable idea node with empty text at the clicked position, focuses its text box for immediate typing, and clears the status-bar tip.
